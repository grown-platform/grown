...
const headBlock = (g) => `<!-- pwa:start -->
    ...
    (function(){
      var ID=${JSON.stringify(g.id)},NAME=${JSON.stringify(g.name)},COLOR=${JSON.stringify(g.color)},HK='grown-hi-'+ID;
      window.GrownGame={
