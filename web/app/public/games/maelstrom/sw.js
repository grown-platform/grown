// Service worker for the Maelstrom PWA.
//
// The engine assets (Maelstrom.wasm ~1.4 MB, Maelstrom.data ~2.4 MB) are served
...
self.addEventListener("fetch", (event) => {
  ...
  if (!url.pathname.includes("/games/maelstrom/")) return;
  ...
  if (url.pathname.endsWith(".html") || url.pathname.endsWith("/games/maelstrom/")) {
